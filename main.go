...
func mapData() {
	myMap := make(map[string]int) // map(typeOf key)typeOf value
...
func structData() {
	...
	var student1 Student // 'student1' = variable 'Student' = type
	student1.Name = "Shin"
	student1.Weight = 60
	student1.Height = 180
	student1.Grade = "F"
	...
	// Print struct values
	fmt.Println(student1) // can use like object in JS like student.Name
}

func structWithArray() {
...
func structWithMap() {
	...
	students["st01"] = Student{Name: "Shin", Weight: 60, Height: 180, Grade: "F"}
	students["st02"] = Student{Name: "Alice", Weight: 55, Height: 165, Grade: "A"}
	students["st03"] = Student{Weight: 68, Height: 175, Grade: "B"}
